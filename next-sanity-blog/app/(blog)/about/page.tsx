    ...
    <div className="about flex flex-col md:flex-row items-center bg-white p-8 md:p-16">
      ...
      <div className="w-full md:w-1/2 flex justify-center">
        <Image width={1000} height={1000}
          src="/file:///C:/Users/HP/Downloads/pb-1.jfif" // Replace this with your image path
          alt="Rehan Aslam"
      ...
      <div className="w-full md:w-1/2 mt-8 md:mt-0 md:pl-12">
        ...
        <h2 className="text-xl text-purple-600 font-semibold mb-4">Rehan Aslam - Developer</h2>
